...
const Footer = () => {
  return (
    <footer className=" w-full p-4 font-medium bg-[#f5f5f5] dark:bg-[#161527] ml-14">
      <div className="pl-[80px] mx-auto max-w-[1080px] lg:pl-0">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="flex mt-4 space-x-3 sm:justify-center sm:mt-0 hidden sm:flex md:flex lg:flex">
            <Image src="/tokenup.png" width={25} height={20} alt="logo" />
            <a
